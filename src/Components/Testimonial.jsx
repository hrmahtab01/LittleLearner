      ...
      <div className="max-w-Container mx-auto">
        ...
        <div className=" mt-[100px] ">
          <Slider {...settings}>
            ...
            <div className="w-[300px] h-[462px] bg-BgColorwhite rounded-[12px] shadow-[10px_8px_0px_0px_#1A1A1A] shadow-SecondaryColor mb-5  ">
            ...
            <div className="w-[3000px] h-[462px] bg-BgColorwhite rounded-[12px] shadow-[10px_8px_0px_0px_#1A1A1A] shadow-SecondaryColor mb-5   ">
              <div className="flex flex-col items-center justify-center">
                <div>
                  <div className="w-[80px] h-[80px] rounded-full bg-[#FFF5F0] flex justify-center items-center mx-auto mt-[50px]">
                    <img
